...
const Index = () => {
  ...
  return <>
      ...
      <section className="bg-gradient-hero px-4 md:px-6 text-center relative overflow-hidden min-h-[calc(100vh-64px)] flex items-center justify-center">
        ...
        {/* Navigation Arrow */}
        <button onClick={scrollToPresentation} className="absolute bottom-2 left-1/2 -translate-x-1/2 text-white/80 hover:text-white transition-sport animate-float-arrow cursor-pointer group" aria-label="Scroll to next section">
