...
**Format attendu pour Products (17 colonnes) :**
```
id, name, type, price_eur, image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, size_guide_url, active, soldout
```
